// src/game/drops.ts
// Drop tables for every skill action + lootbox contents.
// A "drop" is a bonus item on top of the action's normal output.
...
export const SKILL_DROPS: Record<string, DropEntry[]> = {
  ...
  foraging: [
    ...
    // Legendary set piece: The Wanderer's Compass (tracked as special drop id)
  ...
  fishing: [
    ...
    // Legendary set piece: The Leviathan Scale
  ...
  combat: [
    ...
    // Legendary set piece: The Void Blade Fragment
...
export const TRACKABLE_DROPS = new Set([
...
export function openLootbox(id: string): LootboxResult {
