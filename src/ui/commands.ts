...
import type { GameState, NavState, CommandResult } from '../types';
import { SKILL_NAMES, SKILL_LABELS, getSkillLevel, getSeason, addLog, WORLD_MILESTONES } from '../game/state';
import { SKILLS, findAction, matchAction } from '../game/skills';
import { startAction, openBoxFull } from '../game/engine';
import { getSellPrice, getItemLabel, getShopItem, SHOP_ITEMS } from '../game/items';
...
function cmdBuy(state: GameState, args: string[]): CommandResult {
